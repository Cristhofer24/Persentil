  ...
  options: {
    ...
    scales: {
      ...
      y: {
        title: {
          display: true,
          text: "Longitud/Estatura niñas (cm)",
        },
        ticks: {
          stepSize: 5,
          callback: function (value) {
...
function actualizarGrafico(edadAnios, altura, edadMeses) {
  ...
  const datasetPuntoCalculado = growthChart.data.datasets.find(
    (ds) => ds.label === "Punto Calculado"
  );
